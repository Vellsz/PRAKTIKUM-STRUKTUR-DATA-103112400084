...
## Dasar Teori
Multi Linked List merupakan salah satu bentuk lanjutan dari struktur data linked list yang memungkinkan adanya hubungan hierarkis antara beberapa list. Dalam Multi Linked List, setiap elemen pada list utama (sering disebut list induk) dapat memiliki satu atau lebih sublist (list anak) yang juga tersusun dalam bentuk linked list. Konsep ini digunakan untuk merepresentasikan data yang memiliki relasi satu ke banyak, seperti data pegawai yang memiliki beberapa anak, mahasiswa dengan beberapa mata kuliah, atau kategori dengan sejumlah produk.

Secara umum, Multi Linked List dibangun menggunakan pointer yang menghubungkan antar elemen baik pada list induk maupun list anak. Setiap node induk menyimpan informasi data utama serta pointer yang menunjuk ke list anaknya. Operasi dasar pada Multi Linked List meliputi insert (penyisipan) dan delete (penghapusan) baik pada elemen induk maupun elemen anak. Proses penyisipan anak memerlukan identifikasi induk terlebih dahulu agar anak dapat ditempatkan pada posisi yang sesuai, sedangkan penghapusan induk harus diikuti dengan penghapusan seluruh anak yang terhubung dengannya untuk menghindari memory leak.

Multi Linked List juga mendukung berbagai variasi dari linked list lain seperti singly, doubly, atau circular linked list, tergantung pada arah keterhubungan dan kebutuhan traversal data. Dengan demikian, Multi Linked List menjadi struktur data yang efisien untuk mengelola data yang bersifat hierarkis dan kompleks, karena memungkinkan pengaksesan dan manipulasi data dengan fleksibilitas tinggi serta penggunaan memori yang dinamis.
## Guided
